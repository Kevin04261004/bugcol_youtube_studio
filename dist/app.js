...
function pruneAssets(){for(const key of unusedAssetKeys(Object.keys(project.assets),project.sentences.map(s=>s.scene.asset)))delete project.assets[key];}
